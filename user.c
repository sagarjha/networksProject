...
int main(int argc, char* argv[])
{
    ...
    if(argc != 5)
    {
        printf("Usage: <executable> <0 for send, 1 for retrieve> <complete filename> <remoteIP> <remote Port Number>\n");
        return -1;
    }
    ...
    */
    ...
    if(option == 0)
    {
        ...
        for(;;)
        {
            ...
            sendFile(requestSocket, fileName, getSize(fileName));
